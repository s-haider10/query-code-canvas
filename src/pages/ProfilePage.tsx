...
const ProfilePage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#191925] via-[#181825] to-[#21222e]">
      <div className="bg-[#1a1a25]/90 border border-zinc-600/40 p-10 rounded-2xl shadow-2xl flex flex-col items-center w-full max-w-md">
